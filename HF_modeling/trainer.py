...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        # ema_loss_dic_A100 = {"Qwen/Qwen3-1.7B":1.223638079004891, "meta-llama/Llama-3.2-1B-Instruct":1.2971340341855684, "google/gemma-2-2b-it":0.8987508884593939, "google/gemma-3-1b-it":1.2557054350510337}
        ema_loss_dic_H100 = {"Qwen/Qwen3-1.7B":1.2236077547094506, "meta-llama/Llama-3.2-1B-Instruct":1.2968567900402428, "google/gemma-2-2b-it":0.8990658471535802, "google/gemma-3-1b-it":1.25549938350453}

        target_ema_loss = ema_loss_dic_H100[model_name]

        # loss_dic_A100 = {"Qwen/Qwen3-1.7B":0.0286, "meta-llama/Llama-3.2-1B-Instruct":0.3053, "google/gemma-2-2b-it":0.0006, "google/gemma-3-1b-it":0.2497}
        # loss_dic_H100 = {"Qwen/Qwen3-1.7B":0.0279, "meta-llama/Llama-3.2-1B-Instruct":0.0031, "google/gemma-2-2b-it":1, "google/gemma-3-1b-it":0.205}
            ...
            for i in range(total_updates):                
                ...
                for i, inputs in enumerate(batch_samples):
                    ...
                    if do_sync_step:
                        ...
                        # caculate loss EMA
                        if loss_ema is None:
                            loss_ema = real_step_loss
                        else:
                            loss_ema = alpha_ema * real_step_loss + (1 - alpha_ema) * loss_ema
